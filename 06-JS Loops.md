...
| Loop Type              | Definition                                                  | Use Case                                  |
| ---------------------- | ----------------------------------------------------------- | ----------------------------------------- |
| **for loop**           | একটি নির্দিষ্ট সংখ্যা অনুযায়ী code block বারবার চালায়।      | যখন iteration সংখ্যা জানা থাকে।           |
| **while loop**         | শর্ত (condition) true থাকা পর্যন্ত code block চালায়।        | iteration সংখ্যা আগে থেকে জানা না থাকলে।  |
| **do...while loop**    | অন্তত একবার code block চালায়, তারপর condition চেক করে।      | যখন কমপক্ষে একবার কোড চালাতে হয়।          |
| **for...in loop**      | object-এর properties (keys) এর উপর iterate করে।             | object এর key-value পড়তে।                 |
| **for...of loop**      | iterable (array, string, etc) এর values এর উপর iterate করে। | array বা string এর প্রতিটি মান পড়তে।      |
| **forEach() method**   | array এর প্রতিটি element এর জন্য function call করে।         | Array এর values process করতে।             |
| **break statement**    | লুপ বন্ধ করে দেয় যখন শর্ত পূরণ হয়।                          | নির্দিষ্ট condition এ loop থামাতে।        |
| **continue statement** | লুপের বর্তমান iteration বাদ দিয়ে পরেরটিতে যায়।              | নির্দিষ্ট শর্তে কিছু iteration skip করতে। |
